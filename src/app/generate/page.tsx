    ...
    const handleStartCall = async () => {
        if (callActive) {
            ...
            try {
                ...
                await vapi.start(process.env.NEXT_PUBLIC_VAPI_WORKFLOW_KEY as string, {
                    variableValues: {
                        full_name: fullName,
                        user_id: user?.id,
                    }
                ...
                <div className="flex justify-center gap-4">
                    <Button
                        ...
                        className={`w-40 text-xl rounded-3xl
                                ${callActive ? "bg-destructive hover:bg-destructive/80"
                                : callEnded ? "bg-green-600 hover:bg-green-700"
                                    : "bg-primary hover:bg-primary/80"} text-white relative`}
