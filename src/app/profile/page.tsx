...
import CornerElements from "@/components/shared/CornerElements"
import NoFitnessPlan from "@/components/pages/profile/NoFitnessPlan"
                        ...
                        <div className="flex flex-wrap gap-2">
                            {plans.map((plan) => (
                                <Button
                                    ...
                                    className={`text-foreground border hover:text-white ${selectedPlan === plan._id
